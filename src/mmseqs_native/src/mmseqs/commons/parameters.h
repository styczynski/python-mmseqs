...
#include <mmseqs/commons/multiParam.h>
...
struct MMseqsParameter {
  ...
  MMseqsParameter(int uid, const char *n, const char *display, const char *d,
...
class Parameters {
 public:
  ...
  std::vector<MMseqsParameter *> removeParameter(
  ...
  std::vector<MMseqsParameter *> combineList(
