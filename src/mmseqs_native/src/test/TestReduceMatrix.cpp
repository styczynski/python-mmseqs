...
int main(int, const char**) {
  ...
  printf("\n");
  ReducedMatrix redMat(subMat.probMatrix, subMat.subMatrixPseudoCounts,
                       subMat.aa2num, subMat.num2aa, subMat.alphabetSize,
                       reductionAlphabetSize, subMat.getBitFactor());
  std::cout << "\n";
  ...
  std::cout << "aa2num: \n";
  for (char c = 'A'; c <= 'Z'; c++) printf("%c%3d\t", c, subMat.aa2num[(int)c]);
  std::cout << "\n";
  ...
  for (char c = 'A'; c <= 'Z'; c++) printf("%c%3d\t", c, redMat.aa2num[(int)c]);
  std::cout << "\n";
