...
function(compile_resource INPUT_FILE OUTPUT_FILE)
    ...
    string(REGEX REPLACE "/+$" "" INPUT_PATH_NO_TRAILING_SLASH "${PROJECT_SOURCE_DIR}/src/mmseqs_native/src/data/${INPUT_FILE_DIRECTORY}")
    ...
    add_custom_command(OUTPUT ${OUTPUT_FILE}
            ...
            COMMAND ${XXD_EXECUTABLE} ${XXD_PARAMS} ${PROJECT_SOURCE_DIR}/src/mmseqs_native/src/data/${INPUT_FILE} > ${OUTPUT_FILE}
