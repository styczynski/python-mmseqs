...
SearchResults Database::search_file(
    ...
    args.splitMemoryLimit=18000000000;
    args.realignScoreBias=-0.2;
    args.realignMaxSeqs=2147483647;
    args.maskMode = 1;
    args.spacedKmer = true;
    args.evalThr = 0.001;
    args.orfStartMode = 1;
    args.evalProfile = 0.1;
    args.exactKmerMatching = true;
    args.strand = 2;
    args.kmerSize = 15;
    args.setSubstitutionMatrices("blosum62.out", "nucleotide.out");
    args.formatAlignmentMode = 0;
    args.translationTable = 1;
    args.gapOpen = MultiParam<int>(11, 5);
    args.gapExtend = MultiParam<int>(1, 2);
    args.dbOut = 0;
    args.preloadMode = 0;
    args.compressed = 0;
    args.setSubstitutionMatrices("blosum62.out", "nucleotide.out");
    args.addBacktrace = 0;
    args.wrappedScoring = 0;
    args.seqIdThr = 0;
    args.alnLenThr = 0;
    args.seqIdMode = 0;
    args.altAlignment = 0;
    args.covThr = 0;
    args.compBiasCorrection = 1;
    args.maxRejected = 2147483647;
    args.maxAccept = 2147483647;
    args.includeIdentity = 0;
    args.pca = 1;
    args.pcb = 1.5;
    args.scoreBias = 0;
    args.realign = 0;
    args.zdrop = 40;
    args.addBacktrace = true;
    args.setSubstitutionMatrices("blosum62.out", "nucleotide.out");
    args.setSeedSubstitutionMatrices("VTML80.out","nucleotide.out");
    args.split = 0;
    args.splitMode = 2;
    args.covMode = 0;
    args.diagonalScoring = 1;
    args.exactKmerMatching = 0;
    args.minDiagScoreThr = 15;
    args.setSeedSubstitutionMatrices("VTML80.out", "nucleotide.out");
    args.alphabetSize = MultiParam<int>(21, 5);
    args.maskLowerCaseMode = 0;
    args.kmerScore = 0;
    args.checkCompatible = 0;
    args.split = 0;
    args.sequenceOverlap = 0;
    args.sequenceSplitMode = 1;
    args.headerSplitMode = 0;
    args.orfMaxLength = 32734;
    args.orfMaxGaps = 2147483647;
    args.contigStartMode = 2;
    args.contigEndMode = 2;
    args.orfStartMode = 1;
    args.forwardFrames = "1,2,3";
    args.reverseFrames = "1,2,3";
    args.translationTable = 1;
    args.translate = 0;
    args.useAllTableStarts = true;
    args.identifierOffset = 0;
    args.createLookup = 0;
