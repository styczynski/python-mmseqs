...
#include <biosnake/commons/byteParser.h>
...
Parameters::Parameters()
    : scoringMatrixFile("INVALID", "INVALID"),
      ...
      PARAM_MAX_SEQ_LEN(
          ...
          "^[0-9]{1}[0-9]*",
          BiosnakeParameter::COMMAND_COMMON | BiosnakeParameter::COMMAND_EXPERT),
      PARAM_DIAGONAL_SCORING(
          ...
          BiosnakeParameter::COMMAND_PREFILTER | BiosnakeParameter::COMMAND_EXPERT),
      ...
      PARAM_DISK_SPACE_LIMIT(
          ...
          "^(0|[1-9]{1}[0-9]*(B|K|M|G|T)?)$",
          BiosnakeParameter::COMMAND_COMMON | BiosnakeParameter::COMMAND_PREFILTER |
              BiosnakeParameter::COMMAND_EXPERT),
      PARAM_SPLIT_AMINOACID(
          ...
          typeid(bool), (void *)&splitAA, "$", BiosnakeParameter::COMMAND_EXPERT),
      PARAM_SUB_MAT(
      ...
      PARAM_NO_COMP_BIAS_CORR(
          ...
          BiosnakeParameter::COMMAND_PREFILTER | BiosnakeParameter::COMMAND_ALIGN |
      ...
      PARAM_REALIGN(
          ...
          BiosnakeParameter::COMMAND_ALIGN | BiosnakeParameter::COMMAND_EXPERT),
      PARAM_MIN_SEQ_ID(
      ...
      PARAM_ALT_ALIGNMENT(PARAM_ALT_ALIGNMENT_ID, "--alt-ali",
                          ...
                          "^[0-9]{1}[0-9]*$", BiosnakeParameter::COMMAND_ALIGN),
      PARAM_GAP_OPEN(
      ...
      PARAM_CLUSTER_MODE(
          ...
          BiosnakeParameter::COMMAND_CLUST),
      PARAM_CLUSTER_STEPS(
          ...
          BiosnakeParameter::COMMAND_CLUST | BiosnakeParameter::COMMAND_EXPERT),
      ...
      PARAM_DB_OUTPUT(PARAM_DB_OUTPUT_ID, "--db-output", "Database output",
                      ...
                      (void *)&dbOut, "", BiosnakeParameter::COMMAND_EXPERT),
      ...
      PARAM_SKIP_QUERY(PARAM_SKIP_QUERY_ID, "--skip-query", "Skip query",
                       ...
                       (void *)&skipQuery, "", BiosnakeParameter::COMMAND_EXPERT),
      // convertmsa
      ...
      PARAM_MASK_PROFILE(
          ...
          BiosnakeParameter::COMMAND_PROFILE | BiosnakeParameter::COMMAND_EXPERT),
      PARAM_E_PROFILE(
      ...
      PARAM_FIRST_SEQ_REP_SEQ(PARAM_FIRST_SEQ_REP_SEQ_ID, "--first-seq-as-repr",
                              ...
                              BiosnakeParameter::COMMAND_MISC),
      ...
      PARAM_KMER_PER_SEQ(
          ...
          "^[1-9]{1}[0-9]*$", BiosnakeParameter::COMMAND_CLUSTLINEAR),
      PARAM_KMER_PER_SEQ_SCALE(
          ...
          "^0(\\.[0-9]+)?|1(\\.0+)?$", BiosnakeParameter::COMMAND_CLUSTLINEAR),
      ...
      PARAM_CREATE_LOOKUP(
          ...
          (void *)&createLookup, "^[0-1]{1}", BiosnakeParameter::COMMAND_EXPERT),
      // indexdb
      ...
      PARAM_TRANSLATION_TABLE(
          ...
          BiosnakeParameter::COMMAND_MISC | BiosnakeParameter::COMMAND_EXPERT),
      // createseqfiledb
      ...
      PARAM_MERGE_STOP_EMPTY(
          ...
          (void *)&mergeStopEmpty, "", BiosnakeParameter::COMMAND_EXPERT),
      // summarizeresult
      ...
      PARAM_HELP(PARAM_HELP_ID, "-h", "Help", "Help", typeid(bool),
                 (void *)&help, "", BiosnakeParameter::COMMAND_HIDDEN),
      PARAM_HELP_LONG(PARAM_HELP_LONG_ID, "--help", "Help", "Help",
                      typeid(bool), (void *)&help, "",
                      BiosnakeParameter::COMMAND_HIDDEN) {
  if (instance) {
    // Do nothing
  } else {
    instance = this;
...
int compileRegex(biosnake_output* out, regex_t *regex, const char *regexText) {
...
bool parseBool(biosnake_output* out, const std::string &p) {
...
void Parameters::printTaxDbError(biosnake_output* out, const std::string &filename,
...
#ifdef OPENMP
  char *threadEnv = getenv("BIOSNAKE_NUM_THREADS");
  if (threadEnv != NULL) {
...
std::vector<BiosnakeParameter *> Parameters::combineList(
    const std::vector<BiosnakeParameter *> &par1,
    const std::vector<BiosnakeParameter *> &par2) {
  std::vector<BiosnakeParameter *> retVec;
  std::vector<std::vector<BiosnakeParameter *>> tmp;
  tmp.push_back(par1);
  tmp.push_back(par2);
  for (size_t z = 0; z < tmp.size(); z++) {
    std::vector<BiosnakeParameter *> &currPar = tmp[z];
...
size_t Parameters::hashParameter(biosnake_output* out, const std::vector<DbType> &dbtypes,
...
std::string Parameters::createParameterString(
    biosnake_output* out,
    const std::vector<BiosnakeParameter *> &par, bool wasSet) {
...
std::vector<BiosnakeParameter *> Parameters::removeParameter(
    const std::vector<BiosnakeParameter *> &par, const BiosnakeParameter &x) {
  std::vector<BiosnakeParameter *> newParamList;
  for (size_t i = 0; i < par.size(); i++) {
    BiosnakeParameter *p = par[i];
    if (p->name != x.name) newParamList.push_back(p);
  }
  return newParamList;
}

void Parameters::overrideParameterDescription(BiosnakeParameter &par,
