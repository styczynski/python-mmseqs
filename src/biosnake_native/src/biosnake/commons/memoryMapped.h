...
class MemoryMapped {
 public:
  ...
  MemoryMapped(biosnake_output* output);
  /// open file, mappedBytes = 0 maps the whole file
  MemoryMapped(biosnake_output* output, const std::string& filename, size_t mappedBytes = WholeFile,
 ...
 private:
  biosnake_output* out;
  /// don't copy object
  MemoryMapped(biosnake_output* out, const MemoryMapped&);
  /// don't copy object
