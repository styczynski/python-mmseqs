...
int aggregate(biosnake_output *out, const bool useAln, Parameters &par) {
...
int aggregatetaxweights(biosnake_output *out, Parameters &par) {
  return aggregate(out, true, par);
}

int aggregatetax(biosnake_output *out, Parameters &par) {
