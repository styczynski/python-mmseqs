...
Aggregation::Aggregation(biosnake_output* output, const std::string &targetDbName,
...
// build a map with the value in [target column] field as a key and the rest of
// the line, cut in fields, as values
void Aggregation::buildMap(
    char *data, int thread_idx,
