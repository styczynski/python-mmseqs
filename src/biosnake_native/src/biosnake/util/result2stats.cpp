#include <biosnake/util/result2stats.h>

#include <biosnake/commons/aminoAcidLookupTables.h>
...
StatsComputer::StatsComputer(biosnake_output* output, const Parameters &par)
    : out(output),
...
template <typename T>
int StatsComputer::sequenceWise(biosnake_output* out, typename PerSequence<T>::type call,
                                bool onlyResultDb) {
...
int result2stats(biosnake_output *out, Parameters &par) {
