...
int doCompression(biosnake_output* out, Parameters& par, bool shouldCompress) {
...
int compress(biosnake_output* out, Parameters& par) {
  return doCompression(out, par, true);
}

int decompress(biosnake_output* out, Parameters& par) {
