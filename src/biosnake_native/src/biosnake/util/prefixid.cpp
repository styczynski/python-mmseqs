...
int addid(biosnake_output* out, const std::string &db1, const std::string &db1Index,
...
int prefixid(biosnake_output *out, Parameters &par) {
...
int suffixid(biosnake_output *out, Parameters &par) {
  //    Parameters& par = Parameters::getInstance();
  //    par.parseParameters(argc, argv, command, true, 0, 0);
  return (addid(out, par.db1, par.db1Index, par.db2, par.db2Index, par.tsvOut,
