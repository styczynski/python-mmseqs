...
int profile2seq(biosnake_output* out, Parameters& par, bool consensus) {
...
int profile2consensus(biosnake_output* out, Parameters& par) {
  return profile2seq(out, par, true);
}

int profile2repseq(biosnake_output* out, Parameters& par) {
