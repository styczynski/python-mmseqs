...
int easytaxonomy(biosnake_output *out, Parameters &par) {
  ...
  //        par.searchworkflow[i]->addCategory(BiosnakeParameter::COMMAND_EXPERT);
  //    }
  //    for (size_t i = 0; i < par.convertalignments.size(); i++){
  //        par.convertalignments[i]->addCategory(BiosnakeParameter::COMMAND_EXPERT);
  //    }
  //    for (size_t i = 0; i < par.createtsv.size(); i++){
  //        par.createtsv[i]->addCategory(BiosnakeParameter::COMMAND_EXPERT);
  //    }
  //    par.PARAM_S.removeCategory(BiosnakeParameter::COMMAND_EXPERT);
  //    par.PARAM_E.removeCategory(BiosnakeParameter::COMMAND_EXPERT);
