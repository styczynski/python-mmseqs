...
std::vector<DatabaseDownload> downloads = {
    {"UniRef100",
     "The UniProt Reference Clusters provide clustered sets of sequences from "
     "the UniProt Knowledgebase.",
     "Suzek et al: UniRef: comprehensive and non-redundant UniProt reference "
    ...
    {"UniRef50",
     ...
     {}},
    {"UniProtKB",
     "The UniProt Knowledgebase is the central hub for the collection of "
     ...
     "Nucleic Acids Res 47(D1), D506-515 (2019)",
     ...
     {}},
    {"UniProtKB/TrEMBL",
     "UniProtKB/TrEMBL (unreviewed) contains protein sequences associated with "
     "computationally generated annotation and large-scale functional "
     "characterization.",
     "The UniProt Consortium: UniProt: a worldwide hub of protein knowledge. "
     "Nucleic Acids Res 47(D1), D506-515 (2019)",
     "https://www.uniprot.org/help/uniprotkb",
    ...
    {"UniProtKB/Swiss-Prot",
     "UniProtKB/Swiss-Prot (reviewed) is a high quality manually annotated and "
     "non-redundant protein sequence database, which brings together "
     ...
     {}},
    {"NR",
     "Non-redundant protein sequences from GenPept, Swissprot, PIR, PDF, PDB, "
     "and NCBI RefSeq.",
     "NCBI Resource Coordinators: Database resources of the National Center "
     "for Biotechnology Information. Nucleic Acids Res 46(D1), D8-D13 (2018)",
     ...
     {}},
    {"NT",
     "Partially non-redundant nucleotide sequences from all traditional "
     "divisions of GenBank, EMBL, and DDBJ excluding GSS, STS, PAT, EST, HTG, "
     "and WGS.",
     "NCBI Resource Coordinators: Database resources of the National Center "
     "for Biotechnology Information. Nucleic Acids Res 46(D1), D8-D13 (2018)",
     "https://ftp.ncbi.nlm.nih.gov/blast/db/FASTA",
    ...
    {"PDB",
     ...
     "Berman et al: The Protein Data Bank. Nucleic Acids Res 28(1), 235-242 "
     "(2000)",
     "https://www.rcsb.org",
     false,
     Parameters::DBTYPE_AMINO_ACIDS,
     ...
     {}},
    {"PDB70",
     "PDB clustered to 70% sequence identity and enriched using HHblits with "
     "Uniclust sequences.",
     "Steinegger et al: HH-suite3 for fast remote homology detection and deep "
     "protein annotation. BMC Bioinform 20(1), 473 (2019)",
    ...
    {"Pfam-A.full",
     ...
     "El-Gebali and Mistry et al: The Pfam protein families database in 2019. "
     "Nucleic Acids Res 47(D1), D427-D432 (2019)",
     "https://pfam.xfam.org",
     false,
     Parameters::DBTYPE_HMM_PROFILE,
     databases_sh,
    ...
    {"Pfam-A.seed",
     ...
     {}},
    {"Pfam-B",
     "Pfam-B is a large automatically generated supplement to the Pfam "
     "database.",
     ...
     {}},
    {"eggNOG",
     "eggNOG is a hierarchical, functionally and phylogenetically annotated "
     "orthology resource",
     "Huerta-Cepas et al: eggNOG 5.0: a hierarchical, functionally and "
     "phylogenetically annotated orthology resource based on 5090 organisms "
     "and 2502 viruses. Nucleic Acids Res 47(D1), D309–D314 (2019)",
    ...
    {"dbCAN2",
     ...
     "Zhang et al: dbCAN2: a meta server for automated carbohydrate-active "
     ...
     {}},
    {"SILVA",
     "SILVA provides datasets of aligned small and large subunit ribosomal RNA "
     "sequences for all three domains of life.",
     "Yilmaz et al: The SILVA and \"All-species Living Tree Project (LTP)\" "
     "taxonomic frameworks. Nucleic Acids Res 42(D1), D643-D648 (2014)",
     ...
     {{"SILVA_REL", "138"}}},
    {"Resfinder",
     "ResFinder is a database that captures antimicrobial resistance genes "
     "from whole-genome data sets.",
     "Zankari et al: Identification of acquired antimicrobial resistance "
     "genes. J Antimicrob Chemother 67(11), 2640-2644 (2012)",
     ...
     {}},
    {"Kalamari",
     "Kalamari contains over 250 genomes chosen to be representative of agents "
     "tracked by genome-based foodborne disease surveillance, common "
     "contaminants, and diverse phyla and bacterial genera.",
     "Katz et al: Kraken with Kalamari: Contamination Detection. ASM Poster, "
     "270 (2018)",
...
void appendPadded(std::string &dst, const std::string &value, size_t n,
                  int direction = PAD_LEFT, char padding = ' ') {
  if (n < value.size()) {
    dst.append(value);
    return;
  }
...
std::string listDatabases(Parameters &par, bool detailed) {
  ...
  for (size_t i = 0; i < downloads.size(); ++i) {
    ...
    dbTypeWidth = std::max(
        dbTypeWidth, strlen(Parameters::getDbTypeName(downloads[i].dbType)));
  }
  ...
  for (size_t i = 0; i < downloads.size(); ++i) {
    ...
    description.append(1, '\t');
    appendPadded(description, Parameters::getDbTypeName(downloads[i].dbType),
                 dbTypeWidth);
    description.append(1, '\t');
    appendPadded(description, (downloads[i].hasTaxonomy ? "yes" : "-"), 8,
                 PAD_RIGHT);
    description.append(1, '\t');
...
int databases(biosnake_output *out, Parameters &par) {
  //    Parameters &par = Parameters::getInstance();
  //    par.parseParameters(argc, argv, command, false,
  //    Parameters::PARSE_ALLOW_EMPTY, 0);

  std::string description = listDatabases(par, par.help);
  if (par.filenames.size() == 0 || par.help) {
    // par.printUsageMessage(par, par.help ? BiosnakeParameter::COMMAND_EXPERT :
    // 0, description.c_str());
