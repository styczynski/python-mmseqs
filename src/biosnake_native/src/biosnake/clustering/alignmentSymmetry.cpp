...
void AlignmentSymmetry::readInData(biosnake_output* out, DBReader<unsigned int> *alnDbr,
...
size_t AlignmentSymmetry::findMissingLinks(biosnake_output* out, unsigned int **elementLookupTable,
...
void AlignmentSymmetry::addMissingLinks(biosnake_output* out, unsigned int **elementLookupTable,
...
void AlignmentSymmetry::sortElements(biosnake_output* out, unsigned int **elementLookupTable,
