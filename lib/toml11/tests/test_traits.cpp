...
BOOST_AUTO_TEST_CASE(test_has_xxx) {
  ...
  BOOST_TEST(
      toml::detail::has_iterator<std::unordered_set<std::string>>::value);
  ...
  BOOST_TEST(
      toml::detail::has_value_type<std::forward_list<dummy_type>>::value);
  ...
  BOOST_TEST(
      toml::detail::has_value_type<std::unordered_set<std::string>>::value);
...
BOOST_AUTO_TEST_CASE(test_is_xxx) {
  ...
  BOOST_TEST(
      toml::detail::is_container<std::unordered_set<std::string>>::value);
