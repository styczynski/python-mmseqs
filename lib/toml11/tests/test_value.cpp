...
BOOST_AUTO_TEST_CASE(test_value_float) {
  ...
  BOOST_TEST(v2.as_floating() == 3.14, boost::test_tools::tolerance(1e-2));
  ...
  BOOST_TEST(v1.as_floating() == 2.718, boost::test_tools::tolerance(1e-3));
  ...
  BOOST_TEST(v3.as_floating() == 2.718, boost::test_tools::tolerance(1e-3));
  ...
  BOOST_TEST(v5.as_floating() == 2.718, boost::test_tools::tolerance(1e-3));
...
BOOST_AUTO_TEST_CASE(test_value_local_time) {
  ...
  BOOST_TEST(v1.as_local_time() == toml::local_time(12, 30, 45));

  BOOST_TEST(v2.cast<toml::value_t::local_time>() ==
             toml::local_time(12, 30, 45));
  BOOST_TEST(v2.as_local_time() == toml::local_time(12, 30, 45));

  BOOST_TEST(v1.cast<toml::value_t::local_time>() ==
             v2.cast<toml::value_t::local_time>());
  BOOST_TEST(v1.as_local_time() == v2.as_local_time());
  BOOST_TEST(v1.as_local_time(std::nothrow) == v2.as_local_time(std::nothrow));
  ...
  BOOST_TEST(v1.as_local_time() == toml::local_time(1, 30, 0, 100, 0));
  ...
  BOOST_TEST(v3.cast<toml::value_t::local_time>() ==
             toml::local_time(1, 30, 0, 100, 0));
  BOOST_TEST(v3.as_local_time() == toml::local_time(1, 30, 0, 100, 0));
...
BOOST_AUTO_TEST_CASE(test_value_local_datetime) {
  toml::value v1(
      toml::local_datetime(toml::local_date(2018, toml::month_t::Jan, 31),
                           toml::local_time(12, 30, 45)));
  ...
  BOOST_TEST(
      v1.cast<toml::value_t::local_datetime>() ==
      toml::local_datetime(toml::local_date(2018, toml::month_t::Jan, 31),
                           toml::local_time(12, 30, 45)));
  BOOST_TEST(
      ...
      toml::local_datetime(toml::local_date(2018, toml::month_t::Jan, 31),
                           toml::local_time(12, 30, 45)));
  BOOST_TEST(
      v1.as_local_datetime(std::nothrow) ==
      toml::local_datetime(toml::local_date(2018, toml::month_t::Jan, 31),
                           toml::local_time(12, 30, 45)));

  v1 = toml::local_datetime(toml::local_date(2018, toml::month_t::Apr, 1),
  ...
  BOOST_TEST(v1.cast<toml::value_t::local_datetime>() ==
             toml::local_datetime(toml::local_date(2018, toml::month_t::Apr, 1),
                                  toml::local_time(1, 15, 30)));
...
BOOST_AUTO_TEST_CASE(test_value_offset_datetime) {
  ...
  v1 = toml::offset_datetime(toml::local_date(2018, toml::month_t::Apr, 1),
                             toml::local_time(1, 15, 30),
  ...
  BOOST_TEST(v1.cast<toml::value_t::offset_datetime>() ==
             toml::offset_datetime(
                 toml::local_date(2018, toml::month_t::Apr, 1),
                 toml::local_time(1, 15, 30), toml::time_offset(9, 0)));
  BOOST_TEST(v1.as_offset_datetime() ==
             toml::offset_datetime(
                 toml::local_date(2018, toml::month_t::Apr, 1),
                 toml::local_time(1, 15, 30), toml::time_offset(9, 0)));
...
BOOST_AUTO_TEST_CASE(test_value_array) {
  ...
  BOOST_TEST(
      v1.cast<toml::value_t::array>().at(0).cast<toml::value_t::integer>() ==
      1);
  BOOST_TEST(
      v1.cast<toml::value_t::array>().at(1).cast<toml::value_t::integer>() ==
      2);
  BOOST_TEST(
      v1.cast<toml::value_t::array>().at(2).cast<toml::value_t::integer>() ==
      3);
  BOOST_TEST(
      v1.cast<toml::value_t::array>().at(3).cast<toml::value_t::integer>() ==
      4);
  BOOST_TEST(
      v1.cast<toml::value_t::array>().at(4).cast<toml::value_t::integer>() ==
      5);
  ...
  BOOST_TEST(
      v2.cast<toml::value_t::array>().at(0).cast<toml::value_t::integer>() ==
      6);
  BOOST_TEST(
      v2.cast<toml::value_t::array>().at(1).cast<toml::value_t::integer>() ==
      7);
  BOOST_TEST(
      v2.cast<toml::value_t::array>().at(2).cast<toml::value_t::integer>() ==
      8);
  BOOST_TEST(
      v2.cast<toml::value_t::array>().at(3).cast<toml::value_t::integer>() ==
      9);
  BOOST_TEST(
      v2.cast<toml::value_t::array>().at(4).cast<toml::value_t::integer>() ==
      0);
  ...
  BOOST_TEST(
      v3.cast<toml::value_t::array>().at(0).cast<toml::value_t::integer>() ==
      6);
  BOOST_TEST(
      v3.cast<toml::value_t::array>().at(1).cast<toml::value_t::integer>() ==
      7);
  BOOST_TEST(
      v3.cast<toml::value_t::array>().at(2).cast<toml::value_t::integer>() ==
      8);
  BOOST_TEST(
      v3.cast<toml::value_t::array>().at(3).cast<toml::value_t::integer>() ==
      9);
  BOOST_TEST(
      v3.cast<toml::value_t::array>().at(4).cast<toml::value_t::integer>() ==
      0);
...
BOOST_AUTO_TEST_CASE(test_value_table) {
  ...
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("foo")
                 .cast<toml::value_t::integer>() == 42);
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("bar")
                 .cast<toml::value_t::floating>() == 3.14);
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("baz")
                 .cast<toml::value_t::string>()
                 .str == "qux");
  ...
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("foo")
                 .cast<toml::value_t::floating>() == 2.71);
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("bar")
                 .cast<toml::value_t::integer>() == 54);
  BOOST_TEST(v1.cast<toml::value_t::table>()
                 .at("baz")
                 .cast<toml::value_t::string>()
                 .str == "quux");
  ...
  BOOST_TEST(v3.cast<toml::value_t::table>()
                 .at("foo")
                 .cast<toml::value_t::floating>() == 2.71);
  BOOST_TEST(v3.cast<toml::value_t::table>()
                 .at("bar")
