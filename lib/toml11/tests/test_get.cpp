...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_integer_type, value_type,
                              test_value_types) {
  {
    value_type v(42);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_floating_type, value_type,
                              test_value_types) {
  {
    value_type v(3.14);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_string_type, value_type,
                              test_value_types) {
  {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_array, value_type,
                              test_value_types) {
  {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_array_of_array, value_type,
                              test_value_types) {
  {
  ...
  }
  {
    ...
    std::pair<std::vector<int>, std::vector<std::string>> p =
        toml::get<std::pair<std::vector<int>, std::vector<std::string>>>(
            std::move(v));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_table, value_type,
                              test_value_types) {
  {
    const value_type v1{{"key1", 1}, {"key2", 2}, {"key3", 3}, {"key4", 4}};
  ...
  {
    value_type v1{{"key1", 1}, {"key2", 2}, {"key3", 3}, {"key4", 4}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_local_date, value_type,
                              test_value_types) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_local_time, value_type,
                              test_value_types) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_get_toml_local_datetime, value_type,
                              test_value_types) {
  value_type v1(
