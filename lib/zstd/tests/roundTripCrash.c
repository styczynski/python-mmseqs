...
static size_t cctxParamRoundTripTest(void* resultBuff,
  ...
  /* Set parameters */
  CHECK_Z(
      ZSTD_CCtxParam_setParameter(cctxParams, ZSTD_p_compressionLevel, cLevel));
...
static size_t checkBuffers(const void* buff1, const void* buff2,
                           size_t buffSize) {
...
static void roundTripCheck(const void* srcBuff, size_t srcBuffSize,
  ...
  {
    size_t const result =
        testCCtxParams ? cctxParamRoundTripTest(rBuff, cBuffSize, cBuff,
                                                cBuffSize, srcBuff, srcBuffSize)
                       : roundTripTest(rBuff, cBuffSize, cBuff, cBuffSize,
                                       srcBuff, srcBuffSize);
